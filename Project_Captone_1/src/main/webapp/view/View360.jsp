...
<link
	href="${pageContext.request.contextPath}/static/css/photo-sphere-viewer.min.css"
	type="text/css" rel="stylesheet">
<script src="${pageContext.request.contextPath}/static/js/three.min.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/static/js/D.min.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/static/js/doT.min.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/static/js/uevent.min.js"
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath}/static/js/photo-sphere-viewer.min.js"
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath}/static/js/jquery-1.11.2.min.js"
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath}/static/js/bootstrap.min.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/static/js/Projector.js"
	type="text/javascript"></script>
<link href="${pageContext.request.contextPath}/static/css/view360.css"
	type="text/css" rel="stylesheet">
</head>
<body>
	...
	<script type="text/javascript">
		...
		var PSvvvvV = new PhotoSphereViewer({
		    ...
		    markers:[{
			      ...
			      tooltip: {
				     content: '<div class="content-image"><img style="width: 135px;height:90px" src="/Project_Captone_pb2/static/image/30868805938_8b65d6ab7e_k.jpg"></div>',
			        position: 'top'
			      }
			    },
			    {
...
/* 		PSvvvvV.on('dblclick', function(marker) {
		...
		var PSV = new PhotoSphereViewer({
		    ...
		    markers:[{
			      ...
			      tooltip: {
			        content: '<div class="content-image"><img style="width: 135px;height:90px" src="/Project_Captone_pb2/static/image/360-Grad-Fotos-Finanzministerium-4-von-9.jpg"></div>',
			        position: 'top'
			      }
			    },
			    {
		...
		var PSV2 = new PhotoSphereViewer({
		    ...
		    markers:[{
			      ...
			      tooltip: {
			        content: '<div class="content-image"><img style="width: 135px;height:90px" src="/Project_Captone_pb2/static/image/https___photo-sphere-viewer.js.org_assets_Bryce-Canyon-National-Park-Mark-Doliner.jpg"></div>',
			        position: 'top'
			      }
			    },
			    {
