...
<div class="content" id="clickim">
	...
	<div class="navigation">
		<div class="nv-row-1">
			<img class="img-row1" alt="1" src="/Project_Captone_pb2/static/image/https___photo-sphere-viewer.js.org_assets_Bryce-Canyon-National-Park-Mark-Doliner.jpg">
			<div class="nv-row1-ct">1</div>
		</div>
		<div class="nv-row-2">
			<img alt="2" class="img-row2" src="/Project_Captone_pb2/static/image/30868805938_8b65d6ab7e_k.jpg">
			<div class="nv-row1-ct">2</div>
		</div>
		<div class="nv-row-3">
			<img alt="3" class="img-row3" src="/Project_Captone_pb2/static/image/360-Grad-Fotos-Finanzministerium-4-von-9.jpg">
...
/* 		PSvvvvV.on('dblclick', function(marker) {
		...
		var PSV2 = new PhotoSphereViewer({
		    panorama: '/Project_Captone_pb2/static/image/360-Grad-Fotos-Finanzministerium-4-von-9.jpg',
		    container: div2,
		    navbar: 'autorotate zoom fullscreen caption',
		    caption: 'Bryce Canyon National Park <b>&copyr</b>',
		    default_fov: 80,
