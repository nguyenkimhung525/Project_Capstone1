	...
	<div class="imageview">
		...
		var PSvvvvV = new PhotoSphereViewer({
		    ...
		    markers:[{
			      ...
			      longitude: 0,
			      latitude: 0,
			      html: '<a id="event_click" onmouseenter="dung(this)" onmouseleave="chay(this)" onclick="setTimeout(plusSlides(1),3000);">'+
		...
		var PSV = new PhotoSphereViewer({
		    ...
		    markers:[{
			      	...
			      	longitude: 0,
			      	latitude: 0,
			      	html: '<a id="event_click" onmouseenter="dung1(this)" onmouseleave="chay1(this)" onclick="setTimeout(plusSlides(-1),3000);">'+
		      		 	  '<img class="image" src="${pageContext.request.contextPath}/static/image/link.png"/></a>',
		      		anchor: 'bottom right',
			      	scale: [0.5, 1.5],
			      	style: {
